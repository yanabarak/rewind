...
(function (global, factory) {
  ...
  (function (undefined$1) {
        ...
        (function (t) {
          !(function () {
            ...
            function x(n, t, e) {
              ...
              if (n._s === $)
                for (
                  n._s = t, n._v = e, t === U && (L && u(e) && (e.longStack = j(e, n)), un(n));
                  r < o;
    ...
    ('object' === (typeof window === 'undefined' ? 'undefined' : _typeof(window)) && window) ||
      ('object' === (typeof self === 'undefined' ? 'undefined' : _typeof(self)) && self) ||
      ('object' === (typeof global === 'undefined' ? 'undefined' : _typeof(global)) && global) ||
      {}
  ));
  ...
  function createRotationSlider() {
    if (this.properties.rotation_slider) {
      ...
      if (this.options.rotation.slider) {
        ...
        this.properties.rotation_slider.addEventListener(
          detectIE() ? 'change' : 'input',
          function (e) {
  ...
  function createSlider() {
    function changeSliderParameter() {
      ...
      var diffH =
        (this.properties.container.offsetWidth - this.properties.container.offsetHeight) / 2;
      var positionY = this.properties.container.offsetHeight / 2 + 12 - diffH;
      // this.properties.sliderContainer.style.transform =
      //   'translate3d(' + positionX + 'px, ' + positionY + 'px, 0) rotate(-90deg)';
      ...
      this.properties.sliderContainer.style.marginTop = '0px';
  ...
  function createContainer() {
    ...
    container.style.width =
      this.options.container.width + (typeof this.options.container.width === 'string' ? '' : 'px');
  ...
  function createViewport() {
    var viewport = (this.properties.viewport =
      this.properties.viewport || document.createElement('div'));
    var container = this.properties.container;
    var options = this.options;
    var border_width = options.viewport.border.width;
    container.style.width =
      options.viewport.width > container.offsetWidth
        ? options.viewport.width + border_width * 2 + 'px'
        : container.offsetWidth;
    container.style.height =
      options.viewport.height > container.offsetHeight
        ? options.viewport.height + border_width * 2 + 'px'
    ...
    if (options.viewport.border.enable) {
      ...
      options.viewport.border.width =
        viewport_border < options.viewport.border.width
          ? viewport_border
          : options.viewport.border.width;
    } else {
  ...
  function setRotationOrigin() {
    ...
    if (this.options.transformOrigin === 'viewport') {
      ...
      this.properties.image.style.transformOrigin = transformOrigin.call(
        this,
        this.properties.origin_x,
        this.properties.origin_y
      );
      this.properties.image.style.transform = transform.call(this);
    }
  }
  ...
  function createContext() {
    ...
    var mousewheel = function mousewheel(e) {
      ...
      if (
        scale > self.options.zoom.min &&
        scale < self.options.zoom.max &&
        self.options.zoom.mouseWheel &&
        self.options.zoom.enable
      ) {
      ...
      _createClass(Cropme, [
        {
          ...
          value: function resize() {
            ...
            container.style.width =
              ...
              (typeof this.options.container.width === 'string' ? '' : 'px');
            ...
            if (container.offsetWidth > this.options.viewport.width) {
              ...
              container.style.width =
                this.options.viewport.width + this.options.viewport.border.width * 2 + 'px';
            }
          },
        },
        {
          ...
          value: function bind(obj) {
            ...
            return new Promise(function (resolve) {
              _this.properties.image.onload = function () {
                ...
                properties.image.style.transformOrigin = transformOrigin.call(
                  self,
                  origin.x || properties.origin_x,
                  origin.y || properties.origin_y
                );
        ...
        },
        {
          ...
          value: function destroy() {
            ...
            this.properties.wrapper.className = this.properties.wrapper.className.replace(
              'cropme-wrapper',
              ''
            );
            delete this.options;
