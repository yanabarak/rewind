...
(function (factory) {
  ...
  DatePicker.prototype.nodes = function (isOpen) {
    ...
    return (
      _.node(
        'div',
        `<h5 class="black-color col fw-bold mb-20 p-0">${settings.title}
                        </h5>
                        <button type="button"
                            class="btn-close opacity-1 align-top align-self-start ms-auto col-auto p-0"
                            data-clear='clear' aria-label="Close"></button>`,
        'row col-12 p-0 m-0'
      ) +
      _.node(
        'div',
